...
export class EndScene extends Phaser.Scene {
    ...
    create() {
        ...
        <p>Lesli__e, Vincent, Sashiro, Sarah, Philippe, Dr. Game, Antoine Débois, Mounir, Gaël et toutes les autres personnes qui nous ont aidé par leurs retours à construire cette expérience.</p>
        `;
